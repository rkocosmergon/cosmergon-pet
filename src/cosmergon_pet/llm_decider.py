...
_PERSONA_GUIDANCE: dict[str, dict[str, Any]] = {
    "scientist": {
        ...
        "sequence": (
            ...
            "  - IF energy >= 50000 AND a propose_contract line with type=trade_agreement is offered: "
            "pick that propose_contract line — controlled cooperation experiment.\n"
        ...
        "examples": (
            ...
            "  Energy 80k, no evolve/market_buy/market_list, propose_contract trade_agreement offered:\n"
    ...
    "warrior": {
        ...
        "sequence": (
            ...
            "  - IF energy >= 50000 AND a propose_contract line with type=non_aggression is offered: "
            "pick that propose_contract line — buy peace on one flank, free up forces.\n"
        ...
        "examples": (
            ...
            "  Fields full, no evolve/create/buy, energy 80k, propose_contract non_aggression offered:\n"
    ...
    "farmer": {
        ...
        "sequence": (
            ...
            "  - IF energy >= 80000 AND a propose_contract line with type=non_aggression is offered: "
            "pick that propose_contract line — stable neighbours protect a long harvest.\n"
        ...
        "examples": (
            ...
            "  All fields full, energy 100k, no market/evolve, propose_contract non_aggression offered:\n"
    ...
    "expansionist": {
        ...
        "sequence": (
            ...
            "  - IF any evolve line is offered: pick evolve.\n"
            "  - IF energy >= 50000 AND a propose_contract line with type=non_aggression is offered: "
            "pick that propose_contract line — clear a flank, expansion needs an open road.\n"
        ...
        "examples": (
            ...
            "  No create/market_buy/place_cells, energy 70k, propose_contract non_aggression offered:\n"
    ...
    "trader": {
        ...
        "sequence": (
            ...
            "  - IF energy >= 30000 AND a propose_contract line with type=trade_agreement is offered: "
            "pick that propose_contract line — locking in regular flow is trader's specialty.\n"
        ...
        "examples": (
            ...
            "  Energy 50k, no market_buy, no market_list, propose_contract trade_agreement offered:\n"
