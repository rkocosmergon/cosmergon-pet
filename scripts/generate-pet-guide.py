...
def build() -> None:
    ...
    story.append(
        Paragraph(
            ...
            "WiFi eingerichtet), kannst du zu Schritt 2 springen.",
            S_BODY,
        )
    )
    story.append(
    ...
    story.append(bullet("<b>Username + Passwort:</b> <code>pi</code> + starkes Passwort"))
    story.append(
        bullet(
    ...
    story.append(
        bullet("<b>Services \u2192 SSH aktivieren</b> (Passwort-Auth oder eigener Public-Key)")
    )
    story.append(bullet("<b>Locale:</b> Zeitzone + Tastatur"))
    story.append(
        Paragraph(
    ...
    story.append(
        Paragraph(
            ...
            "f\u00fcr alle 40-Pin-RPis identisch (Zero 2 W, 3, 4, 5).",
            S_BODY,
        )
    )
        ...
        KeepTogether(
            [
                ...
                Table(
                    ...
                    style=TableStyle([*TBL_STYLE_BASE, ("FONTNAME", (0, 1), (-1, -1), "DVM")]),
                ),
            ]
        )
    )
        ...
        KeepTogether(
            [
                ...
                Paragraph(
                    ...
                    "der RPi hat mehrere 3.3V- und GND-Pins.",
                    S_SMALL,
                ),
            ]
        )
        ...
        KeepTogether(
            [
                ...
                Table(
                    ...
                    style=TableStyle([*TBL_STYLE_BASE, ("FONTNAME", (0, 1), (0, -1), "DVM")]),
                ),
                Spacer(1, 4 * mm),
            ]
        )
    ...
    story.append(
        Paragraph(
            ...
            "sitzen manchmal nur halb im Header.",
            S_BODY,
        )
    )
    story.append(
                    ...
                    [
                        ...
                        [
                            ...
                            Paragraph(
                                ...
                                "<u>Amazon.de/dp/B09LH5SBPS</u></link>",
                                S_SMALL,
                            ),
                        ],
                        [
                            ...
                            Paragraph(
                                ...
                                "<u>Amazon.de/dp/B010Q57SEE</u></link> (SanDisk Ultra)",
                                S_SMALL,
                            ),
                        ],
                        [
                            ...
                            Paragraph(
                                ...
                                "<u>Amazon.de/dp/B078J78R45</u></link>",
                                S_SMALL,
                            ),
                        ],
                        [
                            ...
                            Paragraph(
                                ...
                                "<u>Amazon.de/dp/B08247Q69J</u></link> (3er-Pack)",
                                S_SMALL,
                            ),
                        ],
                        [
                            ...
                            Paragraph(
                                ...
                                "<u>Amazon.de/dp/B07ZPD7PH8</u></link> (40 Stk.)",
                                S_SMALL,
                            ),
                        ],
                    ],
                    colWidths=[CONTENT_W * 0.30, CONTENT_W * 0.15, CONTENT_W * 0.55],
                    style=TableStyle([*TBL_STYLE_BASE, ("ALIGN", (1, 0), (1, -1), "CENTER")]),
                ),
                Paragraph(
                    "<b>Gesamt: ~49 EUR.</b> Der Zero 2 W hat WiFi, Quad-Core und "
                    "reicht f\u00fcr dieses Projekt locker aus.",
                    S_BODY,
                ),
            ]
        )
